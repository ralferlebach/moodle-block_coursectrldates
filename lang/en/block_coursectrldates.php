...
$string['config_help_header'] = 'Setup help';
$string['config_help_trigger_new'] = 'Course newly created or imported';
$string['config_help_trigger_reset'] = 'Course reset';
$string['config_help_trigger_timedeps'] = 'Activities with time dependencies added';
...
$string['help_yes'] = 'Yes';
$string['no_events'] = 'No upcoming course dates found in the next {$a} weeks.';
